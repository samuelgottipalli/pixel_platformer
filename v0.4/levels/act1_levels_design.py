...
def get_act1_levels():
    ...
    level_0 = {
        ...
        "tiles": [
            ...
            *[
                {"x": 1800 + i * 150, "y": 450 - (i % 2) * 50, "solid": True}
                for i in range(8)
            ],
            *[
                {"x": 1832 + i * 150, "y": 450 - (i % 2) * 50, "solid": True}
                for i in range(8)
            ],
            ...
            *[
                {"x": 5100 + i * 100, "y": 550 - (i % 3) * 50, "solid": True}
                for i in range(10)
            ],
            *[
                {"x": 5132 + i * 100, "y": 550 - (i % 3) * 50, "solid": True}
                for i in range(10)
            ],
        ...
        "coins": [
            ...
            *[
                {"x": 5150 + i * 100, "y": 500 - (i % 3) * 50, "value": 2}
                for i in range(10)
            ],
        ],
        "powerups": [
    ...
    level_1 = {
        ...
        "tiles": [
            ...
            *[{"x": 2400, "y": 640 - i * TILE_SIZE, "solid": True} for i in range(12)],
            ...
            # Descent
            *[
                {"x": 2600 + i * 100, "y": 300 + i * 40, "solid": True}
                for i in range(10)
            ],
            *[
                {"x": 2632 + i * 100, "y": 300 + i * 40, "solid": True}
                for i in range(10)
            ],
            ...
            *[{"x": 6500, "y": 400, "solid": True}],
            # Maze-like platforms
            *[
                {"x": 6200 + (i % 5) * 120, "y": 550 - (i // 5) * 60, "solid": True}
                for i in range(15)
            ],
            *[
                {"x": 6232 + (i % 5) * 120, "y": 550 - (i // 5) * 60, "solid": True}
                for i in range(15)
            ],
            ...
            *[{"x": 7000 + i * TILE_SIZE, "y": 640, "solid": True} for i in range(32)],
            # Staircase to exit
            *[
                {"x": 7200 + i * 80, "y": 600 - i * 50, "solid": True}
                for i in range(10)
            ],
            *[
                {"x": 7232 + i * 80, "y": 600 - i * 50, "solid": True}
                for i in range(10)
            ],
            # Exit platform
        ...
        "coins": [
            ...
            *[
                {"x": 6250 + (i % 5) * 120, "y": 500 - (i // 5) * 60, "value": 2}
                for i in range(15)
            ],
        ],
        "powerups": [
