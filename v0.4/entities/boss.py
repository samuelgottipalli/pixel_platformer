...
from config.settings import (
    WHITE, RED, YELLOW, CYAN, PURPLE, ORANGE,
...
class Boss:
    ...
    def _get_boss_colors(self):
        ...
        schemes = {
            ...
            'forest': {'primary': (50, 150, 50), 'secondary': (100, 200, 100), 'accent': YELLOW},
    ...
    def draw(self, surface, camera_x, camera_y):
        ...
        for i in range(self.phase):
            ...
            pygame.draw.circle(surface, self.colors['accent'], (core_x, core_y), core_size)
    ...
    def draw_health_bar(self, surface):
        ...
        pygame.draw.line(surface, WHITE, (phase_marker_x1, bar_y), (phase_marker_x1, bar_y + bar_height), 2)
        pygame.draw.line(surface, WHITE, (phase_marker_x2, bar_y), (phase_marker_x2, bar_y + bar_height), 2)
...
class BossProjectile:
    ...
    def draw(self, surface, camera_x, camera_y):
        ...
        # Glowing projectile
        pygame.draw.circle(surface, self.color, (int(screen_x + self.width // 2), 
                                                 int(screen_y + self.height // 2)), 
                          self.width // 2)
        pygame.draw.circle(surface, WHITE, (int(screen_x + self.width // 2), 
                                            int(screen_y + self.height // 2)), 
                          self.width // 2, 2)
