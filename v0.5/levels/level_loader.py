    ...
    def _create_fallback_levels():
        ...
        level1 = {
            ...
            "tiles": [
                ...
                *[{"x": i * TILE_SIZE, "y": 640, "solid": True} for i in range(100)],
                # Platforms
                *[
                    {"x": 400 + i * TILE_SIZE, "y": 500, "solid": True}
                    for i in range(5)
                ],
                *[
                    {"x": 700 + i * TILE_SIZE, "y": 400, "solid": True}
                    for i in range(4)
                ],
                *[
                    {"x": 1000 + i * TILE_SIZE, "y": 300, "solid": True}
                    for i in range(6)
                ],
                # Walls
                *[
                    {"x": 1500, "y": 640 - i * TILE_SIZE, "solid": True}
                    for i in range(8)
                ],
            ],
            "enemies": [
        ...
        level2 = {
            ...
            "tiles": [
                ...
                *[
                    {"x": 300 + i * TILE_SIZE, "y": 520, "solid": True}
                    for i in range(8)
                ],
                *[
                    {"x": 800 + i * TILE_SIZE, "y": 420, "solid": True}
                    for i in range(6)
                ],
                *[
                    {"x": 1300 + i * TILE_SIZE, "y": 320, "solid": True}
                    for i in range(5)
                ],
                *[
                    {"x": 1800, "y": 640 - i * TILE_SIZE, "solid": True}
                    for i in range(10)
                ],
                *[
                    {"x": 2000 + i * TILE_SIZE, "y": 450, "solid": True}
                    for i in range(10)
                ],
            ],
            "enemies": [
            ...
            "keys": [{"x": 3500, "y": 590, "color": [255, 0, 0]}],
            "portals": [{"x": 3700, "y": 550, "dest": 2}],
        }
        ...
        level3 = {
            ...
            "tiles": [
                ...
                *[
                    {"x": 400 + i * 64, "y": 500 - i * 40, "solid": True}
                    for i in range(10)
                ],
                *[
                    {"x": 1500 + i * TILE_SIZE, "y": 350, "solid": True}
                    for i in range(8)
                ],
                *[
                    {"x": 2200 + i * TILE_SIZE, "y": 450, "solid": True}
                    for i in range(12)
                ],
            ],
            "enemies": [
            ...
            "keys": [],
            "portals": [{"x": 3200, "y": 550, "dest": 0}],  # Back to level 1 for demo
        }
