...
from config.settings import SCREEN_WIDTH, SCREEN_HEIGHT, FPS, BLACK, WHITE, YELLOW, CYAN
...
class AdminMode:
    ...
    def _start_level(self, level_index):
        ...
        if 0 <= level_index < self.level_count:
            ...
            print(f"✓ Admin Mode: Started Level {level_index} on {difficulty} difficulty")
    ...
    def _draw_menu(self):
        ...
        # Level list
        list_y = 380
        self.screen.blit(self.font_medium.render("Select Level:", True, CYAN), 
                        (100, list_y))
