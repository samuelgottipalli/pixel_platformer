...
def get_act1_levels_2_to_6():
    """Get expanded Level 2-6 designs"""
    levels = []
    
    # ============================================================
    # LEVEL 2: "RISING CONFLICT" (18 minutes, 8500px)
    # ============================================================
    # Theme: Vertical progression with combat challenges
    ...
    level_2 = {
        ...
        'tiles': [
            ...
            *[{'x': 4800 + i * TILE_SIZE, 'y': 400, 'solid': True} for i in range(35)],  # Ceiling
    ...
    # ============================================================
    # Theme: Massive vertical tower with precision platforming
    ...
    level_3 = {
        ...
        'tiles': [
            ...
            *[{'x': 300 + i * TILE_SIZE, 'y': 550, 'solid': True} for i in range(6)],  # Low path
            *[{'x': 600 + i * TILE_SIZE, 'y': 450, 'solid': True} for i in range(6)],  # Mid path
            *[{'x': 900 + i * TILE_SIZE, 'y': 350, 'solid': True} for i in range(6)],  # High path
            # Converge
            *[{'x': 1500 + i * TILE_SIZE, 'y': 640, 'solid': True} for i in range(10)],
            
            # === AREA 2: FIRST TOWER (1800-3200) ===
            # Narrow tower with alternating platforms
            *[{'x': 1900, 'y': 640 - i * TILE_SIZE, 'solid': True} for i in range(20)],  # Left wall
            *[{'x': 2100, 'y': 640 - i * TILE_SIZE, 'solid': True} for i in range(20)],  # Right wall
            ...
            *[{'x': 3232 + i * 150, 'y': 150, 'solid': True} for i in range(10)],
            # Gaps between bridges (challenging)
            
            # === AREA 4: SECOND TOWER (4500-6000) ===
            # Wider tower with more complex platforming
            *[{'x': 4600, 'y': 640 - i * TILE_SIZE, 'solid': True} for i in range(20)],  # Left wall
            *[{'x': 4900, 'y': 640 - i * TILE_SIZE, 'solid': True} for i in range(20)],  # Right wall
            ...
            *[{'x': 6100, 'y': 640 - i * TILE_SIZE, 'solid': True} for i in range(22)],  # Single wall
    ...
    # ============================================================
    # Theme: Final test before boss - all mechanics required
    ...
    level_5 = {
        ...
        'powerups': [
            ...
            {'x': 9200, 'y': 150, 'type': 'health'},  # Before boss
            {'x': 9650, 'y': 590, 'type': 'health'},  # Before boss door
        ],
        'keys': [],
        'portals': [
            {'x': 9850, 'y': 110, 'dest': 6, 'color': [255, 0, 0]}  # Red portal to boss
        ]
    }
...
2. In level_loader.py:

from act1_levels_complete import get_act1_levels_2_to_6

def create_default_levels():
    levels = []
    
    # Add Level 0 (Tutorial) and Level 1 from previous design
    # ... (your existing level 0 and 1 code)
    
    # Add Levels 2-6
    levels.extend(get_act1_levels_2_to_6())
    
    return levels

3. Total Act 1 will be:
   - Level 0: Tutorial (15 min, 6400px)
   - Level 1: The Awakening (20 min, 8000px)
   - Level 2: Rising Conflict (18 min, 8500px)
   - Level 3: The Ascent (20 min, 9000px)
   - Level 4: Deep Dive (20 min, 9500px)
   - Level 5: Convergence (20 min, 10000px)
   - Level 6: Boss Fight (15 min, Arena)
   
   TOTAL: ~130 minutes = 2+ hours of gameplay!
